...
def getVisaAdvisory(citizenship, destination, language):
    try:
        if language == 'ru':
            ...
            passport = process.extractOne(citizenship, countries, score_cutoff=75, scorer=fuzz.token_sort_ratio)[0]
            to = process.extractOne(destination, countries, score_cutoff=75, scorer=fuzz.token_sort_ratio)[0]
    except Exception:
