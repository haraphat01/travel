...
to_edit = {
    'ru': {
        ...
        'city_life': '\n\n🥂Развлечения',
        'infrastructure': '\n\n🏘️Инфраструктура',
        'population_150k': '\n\n🤏Маленький(меньше, чем 150K человек)',
        'population_200k': '\n\n🏠Средний(>200K человек)',
        'population_500k': '\n\n🏙Большой(>500K человек)',
        'spicy_normal_cold': '\n\n🥳Дружелюбные😐Нормальные😶Безразлично',
...
questions = {
    'ru': {
        ...
        'feedback_profile': "Оцените, пожалуйста, работу поиска стран/городов",
        'feedback_visa': "Оцените, пожалуйста, работу визовой консультации",
        'feedback_experts': "Оцените, пожалуйста, работу экспертов",
